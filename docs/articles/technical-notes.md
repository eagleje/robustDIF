...
## 1 The Updated Robust DIF Procedure

### 1.1 Defining the Estimator
...
### 1.2 Choosing the Scaling Factors $s_{i}$
...
### 1.3 The Asymptotic Distribution of $\widetilde{\theta}$
